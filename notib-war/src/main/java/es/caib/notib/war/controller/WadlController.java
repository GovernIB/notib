...
//
//import es.caib.notib.core.api.service.rest.RestController;

//@Controller
//@RequestMapping("/notificacio/application.wadl")
...
//		Doc doc = new Doc();
//		doc.setTitle("Notificacio REST Service WADL");
...
//          
//            boolean isRestController = bean instanceof RestController; 
////            boolean isRestContoller = bean.getClass().isAnnotationPresent(Controller.class);
//            if(!isRestController) {
//                continue;
//            }
...
//                            Param waldParam = new Param();
//                            QName nm = convertJavaToXMLType(paramType);
//                            waldParam.setName(paramType.getSimpleName());
//                            waldParam.setStyle(ParamStyle.HEADER);
//                            waldParam.setRequired(param2.required());
//                            waldParam.setType(nm);
//                            wadlRequest.getParam().add(waldParam);
