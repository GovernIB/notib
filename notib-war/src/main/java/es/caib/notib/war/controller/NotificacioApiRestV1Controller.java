...
public class NotificacioApiRestV1Controller extends NotificacioApiRestBaseController {
	...
	@ApiOperation(value = "Genera el justificant i consulta la informació del registre d'una notificació.",
					notes = "Retorna la informació del registre i el justificant d'una notificació dins Notib.", response = RespostaConsultaDadesRegistre.class)
	@ResponseBody
	public RespostaConsultaDadesRegistre consultaDadesRegistre(@ApiParam(name = "dadesConsulta",
			value = "Objecte amb les dades necessàries per consultar les dades de registre d'una notificació o enviament", required = false)
