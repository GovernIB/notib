...
<body>
	<table
		...
		data-url="<c:url value="/procediment"/>"
		...
		<thead>
			<tr>
				<th data-col-name="nom"><spring:message code="procediment.list.permis.columna.nom"/></th>
				<th data-col-name="consulta"><spring:message code="procediment.list.permis.columna.consulta"/></th>
				<th data-col-name="processar"><spring:message code="procediment.list.permis.columna.processar"/></th>
				<th data-col-name="notificacio"><spring:message code="procediment.list.permis.columna.notificacio"/></th>
				<th data-col-name="gestio"><spring:message code="procediment.list.permis.columna.gestio"/></th>
