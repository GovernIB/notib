...
<html>
<head>
    <title><spring:message code="organgestor.actualitzacio.auto"/></title>
...
<c:if test="${not isUpdatingOrgans}">
    ...
    <c:set var="formAction"><not:modalUrl value="/organgestor/update"/></c:set>
...
<c:if test="${isUpdatingOrgans}">
    <div class="confirmacio">
        <h4><spring:message code="organgestor.actualitzacio.procesActiu"/></h4>
    </div>
</c:if>
</body>
</html>
