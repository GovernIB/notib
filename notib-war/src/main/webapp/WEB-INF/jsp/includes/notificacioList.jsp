    ...
    function mostraEnviamentsNotificacio(td, rowData) {
        ...
        $.get(getUrl).done(function(data) {
            ...
            for (i = 0; i < data.length; i++) {
                ...
                } else if (data[i].notificacioEstat == 'REGISTRADA' && (data[i].registreEstat && data[i].registreEstat === 'OFICI_EXTERN')){
    ...
    <tr>
        ...
        <th data-col-name="estat" data-template="#cellEstatTemplate"  width="120px">
            ...
            <script id="cellEstatTemplate" type="text/x-jsrender">
						...
						{{else estat == 'ENVIADA' || estat == 'ENVIAT_SIR' || estat == 'ENVIADA_AMB_ERRORS'}}
							<span class="fa fa-send-o"></span>
							{{:~eval('notificacioEstats["' + estat + '"]')}}
						{{else estat == 'FINALITZADA' || estat == 'FINALITZADA_AMB_ERRORS'}}
