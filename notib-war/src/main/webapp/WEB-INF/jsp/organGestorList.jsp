...
<%--				</c:if>--%>
				...
				<th data-col-name="estat" data-template="#cellEstatTemplate">
					...
					<script id="cellEstatTemplate" type="text/x-jsrender">
						...
						{{else estat == 'E'}}
							<spring:message code="es.caib.notib.core.api.dto.organisme.OrganGestorEstatEnum.E"/>
						{{else estat == 'A'}}
							<spring:message code="es.caib.notib.core.api.dto.organisme.OrganGestorEstatEnum.A"/>
						{{else estat == 'T'}}
							<spring:message code="es.caib.notib.core.api.dto.organisme.OrganGestorEstatEnum.T"/>
						{{else}}
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="organgestor/{{:id}}/sincronitzar/LIST" data-toggle="ajax"><span class="fa fa-refresh"></span>&nbsp;&nbsp;<spring:message code="organgestor.list.boto.synchronize"/></a></li>
