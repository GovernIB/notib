...
<head>
	...
	<script type="text/javascript">
 		...
 		$(document).ready(function() {
 			...
 			$('#notificacion').on('rowinfo.dataTable', function(e, td, rowData) {
		        $.get("<c:url value="/consulta/"/>" + rowData.id + "/destinatari").done(function(data) {
		        	$(td).append(	
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a onClick="callPDF({{:id}})" data-toggle="modal"> <span class="fa fa-download"></span>&nbsp;&nbsp;<spring:message code="notificacio.list.boto.descarregar.document"/> </a></li>
