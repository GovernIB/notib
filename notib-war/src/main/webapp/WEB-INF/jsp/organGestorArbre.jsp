...
<head>
    ...
    <script type="text/javascript">
        ...
        function changedCallback(e, data) {
            console.log("clicck click click");
        }
...
<%--                <c:set var="fillsAtributInfoText"><span style="padding-top: 4.5px; padding-left: 2px;" class="fa fa-warning text-danger pull-right" title="<spring:message code="unitat.arbre.unitatObsoleta"/>"></span></c:set>--%>
                ...
                <not:arbre id="arbreOrgans" atributId="codi" atributNom="nom" arbre="${arbreOrgans}" fulles="${organs}" fullesAtributId="id" fullesAtributNom="codi"
                           fullesAtributPare="codi"  fullesIcona="fa fa-inbox fa-lg" changedCallback="changedCallback" isArbreSeleccionable="${false}" isFullesSeleccionable="${true}" isOcultarCounts="${true}"/>
