...
<body>
	...
	<script id="botonsTemplate" type="text/x-jsrender">
		<p style="text-align:right"><a id="pagadorpostal-boto-nou" class="btn btn-default" href="${unitatCodiUrlPrefix}pagadorPostal/new" data-toggle="modal"><span class="fa fa-plus"></span>&nbsp;<spring:message code="pagadorpostal.list.boto.nou.pagadorpostal"/></a></p>
	</script>
