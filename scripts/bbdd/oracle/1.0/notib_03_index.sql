...
CREATE INDEX NOT_ENTITAT_ENTITATUSU_FK_I ON NOT_ENTITAT_USUARI(ENTITAT_ID);
CREATE INDEX NOT_USUARI_ENTITATUSU_FK_I ON NOT_ENTITAT_USUARI(USAURI_CODI);
CREATE INDEX NOT_USUCRE_ENTITATUSU_FK_I ON NOT_ENTITAT_USUARI(CREATEDBY_CODI);
CREATE INDEX NOT_USUMOD_ENTITATUSU_FK_I ON NOT_ENTITAT_USUARI(LASTMODIFIEDBY_CODI);
