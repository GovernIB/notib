...
ALTER TABLE NOT_ENTITAT_USUARI ADD (
  CONSTRAINT NOT_ENTITAT_USUARI_PK PRIMARY KEY (ID));

ALTER TABLE NOT_NOTIFICACIO ADD (
  CONSTRAINT NOT_NOTIFICACIO_PK PRIMARY KEY (ID));

ALTER TABLE NOT_NOTIFICACIO_DEST ADD (
  CONSTRAINT NOT_NOTIFICACIO_DEST_PK PRIMARY KEY (ID));
...
ALTER TABLE NOT_ENTITAT_USUARI ADD (
  CONSTRAINT NOT_ENTITAT_ENTITATUSU_FK FOREIGN KEY (ENTITAT_ID)
	  REFERENCES NOT_ENTITAT (ID),
  CONSTRAINT NOT_USUARI_ENTITATUSU_FK FOREIGN KEY (USUARI_CODI)
    REFERENCES NOT_USUARI (CODI),
  CONSTRAINT NOT_USUCRE_ENTITATUSU_FK FOREIGN KEY (CREATEDBY_CODI)
    REFERENCES NOT_USUARI (CODI),
  CONSTRAINT NOT_USUMOD_ENTITATUSU_FK FOREIGN KEY (LASTMODIFIEDBY_CODI)
    REFERENCES NOT_USUARI (CODI));

ALTER TABLE NOT_NOTIFICACIO ADD (
  CONSTRAINT NOT_NOTEVE_NOTIFICACIO_FK FOREIGN KEY (ERROR_EVENT_ID)
...
ALTER TABLE NOT_NOTIFICACIO_DEST ADD (
  CONSTRAINT NOT_NOTEVE_NOTERR_NOTDEST_FK FOREIGN KEY (NOTIFICA_ERROR_EVENT_ID)
	  REFERENCES NOT_NOTIFICACIO_EVENT (ID),
  CONSTRAINT NOT_NOTEVE_SEUERR_NOTDEST_FK FOREIGN KEY (SEU_ERROR_EVENT_ID)
	  REFERENCES NOT_NOTIFICACIO_EVENT (ID),
  CONSTRAINT NOT_NOTIFICACIO_NOTDEST_FK FOREIGN KEY (NOTIFICACIO_ID)
	  REFERENCES NOT_NOTIFICACIO (ID),
  CONSTRAINT NOT_USUCRE_NOTDEST_FK FOREIGN KEY (CREATEDBY_CODI)
    REFERENCES NOT_USUARI (CODI),
  CONSTRAINT NOT_USUMOD_NOTDEST_FK FOREIGN KEY (LASTMODIFIEDBY_CODI)
    REFERENCES NOT_USUARI (CODI));

ALTER TABLE NOT_NOTIFICACIO_EVENT ADD (
  CONSTRAINT NOT_NOTIFICACIO_NOTEVENT_FK FOREIGN KEY (NOTIFICACIO_ID)
	  REFERENCES NOT_NOTIFICACIO (ID),
  CONSTRAINT NOT_NOTDEST_NOTEVENT_FK FOREIGN KEY (NOTIFICACIO_DEST_ID)
	  REFERENCES NOT_NOTIFICACIO_DEST (ID),
