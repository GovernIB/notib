...
(
  ...
  REGISTRE_EXTRACTE			VARCHAR2(52)		NOT NULL,
  REGISTRE_DOC_FISICA		VARCHAR2(256)		NOT NULL,
  REGISTRE_IDIOMA			VARCHAR2(52)		NOT NULL,
  REGISTRE_TIPUS_ASSUMPTE	VARCHAR2(256)		NOT NULL,
  REGISTRE_NUM_EXPEDIENT	VARCHAR2(256)		NOT NULL,
  REGISTRE_REF_EXTERNA		VARCHAR2(52)		NOT NULL,
  REGISTRE_CODI_ASSUMPTE	VARCHAR2(256)		NOT NULL,
  REGISTRE_OBSERVACIONS		VARCHAR2(256)		NOT NULL,
