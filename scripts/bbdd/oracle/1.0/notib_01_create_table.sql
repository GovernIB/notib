...
(
  ...
  REGISTRE_NUMERO			VARCHAR2(256),
  REGISTRE_DATA				DATE,
  REGISTRE_EXTRACTE			VARCHAR2(64),
  REGISTRE_DOC_FISICA		VARCHAR2(64),
  REGISTRE_IDIOMA			VARCHAR2(2),
  REGISTRE_TIPUS_ASSUMPTE	NUMBER(1),
  REGISTRE_NUM_EXPEDIENT	VARCHAR2(20),
  REGISTRE_REF_EXTERNA		VARCHAR2(64),
  REGISTRE_CODI_ASSUMPTE	VARCHAR2(20),
