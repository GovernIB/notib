...
(
  ...
  REGISTRE_ORGAN			VARCHAR2(64),
  REGISTRE_OFICINA			VARCHAR2(64),
  REGISTRE_LLIBRE			VARCHAR2(64),
  REGISTRE_EXTRACTE			VARCHAR2(64)		NOT NULL,
  REGISTRE_DOC_FISICA		VARCHAR2(64)		NOT NULL,
  REGISTRE_IDIOMA			VARCHAR2(2)		NOT NULL,
  REGISTRE_TIPUS_ASSUMPTE	VARCHAR2(1)		NOT NULL,
  REGISTRE_NUM_EXPEDIENT	VARCHAR2(20)		NOT NULL,
  REGISTRE_REF_EXTERNA		VARCHAR2(64)		NOT NULL,
  REGISTRE_CODI_ASSUMPTE	VARCHAR2(20)		NOT NULL,
