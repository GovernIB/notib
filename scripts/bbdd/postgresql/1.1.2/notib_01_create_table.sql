...
(
  ...
  DIR3_CODI            		character varying(9)  		NOT NULL,
  DIR3_CODI_REG 			character varying(9),
...
(
  ...
  DOM_VIA_NOM          		character varying(50),
  DOM_NUM_TIPUS        		BIGSERIAL(10),
  DOM_NUM_NUM          		character varying(5),
  ...
  NOTIFICA_INTENT_NUM		BIGSERIAL(10, 0),
  NOTIFICACIO_ID       		BIGSERIAL(19)			NOT NULL,
  SIR_CON_DATA				timestamp without time zone,
  SIR_CON_INTENT 			BIGSERIAL(10) 			NOT NULL,
  CREATEDBY_CODI       		character varying(64),
  CREATEDDATE          		timestamp without time zone,
  LASTMODIFIEDBY_CODI  		character varying(64),
  LASTMODIFIEDDATE     		timestamp without time zone
...
(
  ...
  LLINATGE1				character varying(40),
...
(
  ...
  NORMALITZAT			BIGSERIAL(1, 0),
  GENERAR_CSV			BIGSERIAL(1, 0),
