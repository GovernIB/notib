...
ALTER TABLE ONLY NOT_PERSONA ADD CONSTRAINT NOT_PERSONA_NOT_FK FOREIGN KEY (NOTIFICACIO_ENV_ID) REFERENCES NOT_NOTIFICACIO_ENV (ID);
    
ALTER TABLE ONLY NOT_NOTIFICACIO_ENV ADD CONSTRAINT NOT_PERSONA_NOTIFICACIO_ENV_FK FOREIGN KEY (TITULAR_ID)REFERENCES NOT_PERSONA (ID);

ALTER TABLE ONLY NOT_NOTIFICACIO ADD CONSTRAINT NOT_DOCUMENT_NOTIFICACIO_FK FOREIGN KEY (DOCUMENT_ID) REFERENCES NOT_DOCUMENT (ID);

ALTER TABLE ONLY NOT_NOTIFICACIO ADD CONSTRAINT NOT_PAGADOR_POSTAL_NOTIFICACIO_FK FOREIGN KEY (PAGADOR_POSTAL_ID) REFERENCES NOT_PAGADOR_POSTAL (ID);

ALTER TABLE ONLY NOT_NOTIFICACIO ADD CONSTRAINT NOT_PAGADOR_CIE_NOTIFICACIO_FK FOREIGN KEY (PAGADOR_CIE_ID) REFERENCES NOT_PAGADOR_CIE (ID);

ALTER TABLE ONLY NOT_NOTIFICACIO ADD CONSTRAINT NOT_PROCEDIMENT_NOT_FK FOREIGN KEY (PROCEDIMENT_ID) REFERENCES NOT_PROCEDIMENT (ID);
