...
(
  ...
  REGISTRE_NUMERO			character varying(256),
  REGISTRE_DATA				date,
  REGISTRE_EXTRACTE			character varying(64),
  REGISTRE_DOC_FISICA		character varying(64),
  REGISTRE_IDIOMA			character varying(2),
  REGISTRE_TIPUS_ASSUMPTE	integer(1),
  REGISTRE_NUM_EXPEDIENT	character varying(256),
  REGISTRE_REF_EXTERNA		character varying(64),
  REGISTRE_CODI_ASSUMPTE	character varying(256),
