...
(
  ...
  LLIBRE_NOM 				character varying(64),
  OFICINA					character varying(64),
  OFICINA_NOM 				character varying(64),
...
(
  ...
  PAGADOR_POSTAL_ID			integer(19),
  PAGADOR_CIE_ID			integer(19),
  ...
  REGISTRE_NUM_EXPEDIENT	character varying(256),
...
(
  ID                   BIGSERIAL                NOT NULL,
  TITULAR_ID           BIGSERIAL(19)   NOT NULL,
  DESTINATARI      	   BIGSERIAL(19)   NOT NULL,
  DOM_TIPUS            integer,
  ...
  NOTIFICA_ESTAT_DATA  	timestamp without time zone(6),
  NOTIFICA_ESTAT_DATAACT timestamp without time zone(6),
  ...
  NOTIFICA_CER_DATA    	timestamp without time zone(6),
  ...
  NOTIFICA_INTENT_DATA  timestamp without time zone(6),
