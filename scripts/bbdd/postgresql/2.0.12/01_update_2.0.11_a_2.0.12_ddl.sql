...
ALTER TABLE not_notificacio_env_table ADD organ_id numeric;
...
ALTER TABLE not_aplicacio ADD aplicar_limit_env NUMBER(1) DEFAULT '1' NOT NULL;
ALTER TABLE NOT_NOTIFICACIO_ENV ALTER COLUMN NOTIFICA_DATAT_RECNIF TYPE VARCHAR(50) USING (NOTIFICA_DATAT_RECNIF::VARCHAR(50));
