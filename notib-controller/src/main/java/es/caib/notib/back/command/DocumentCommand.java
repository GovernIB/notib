...
public class DocumentCommand {
	...
	public static DocumentCommand asCommand(DocumentV2 dto) {

		return dto != null ? ConversioTipusHelper.convertir(dto, DocumentCommand.class ) : new DocumentCommand();
	}
	public static DocumentV2 asDto(DocumentCommand command) {
		...
		return command == null || (
				...
				? null : ConversioTipusHelper.convertir(command, DocumentV2.class);
	}
