<%@page import="es.caib.notib.logic.intf.dto.TipusDocumentEnumDto"%>
...
<%--				<not:inputFile name="logoCap" textKey="entitat.form.camp.conf.logocap" fileName="${entitatCommand.logoCapNom}" logoMenu="true" inputSize="6"/>--%>
<%--				<not:inputFile name="logoPeu" textKey="entitat.form.camp.conf.logopeu" fileName="${entitatCommand.logoPeuNom}" logoMenu="false" inputSize="6"/>--%>
...
<%--				<not:inputText name="logoCap" textKey="entitat.form.camp.conf.logocap"/>--%>
<%--				<not:inputText name="logoPeu" textKey="entitat.form.camp.conf.logopeu"/>--%>
