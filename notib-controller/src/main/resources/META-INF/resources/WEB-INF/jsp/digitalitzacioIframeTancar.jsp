...
<%@ taglib tagdir="/WEB-INF/tags/not" prefix="not"%>
...
if (rootIframe) {
	...
	var urlCancel = "<span class='btn btn-default scan-cancel-btn'><spring:message code='notificacio.form.document.camp.escaneig.cancelar'/></span>";
