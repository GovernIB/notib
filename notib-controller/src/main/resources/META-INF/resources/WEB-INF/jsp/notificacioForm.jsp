	...
	$(document).ready(function() {
		...
		if (${validaFirmaWebEnabled} == true) {
			$('input[type="file"]').on('change', (event) => {
				...
				$('<p id="cercle-validacio" class="validating-block text-info"><span class="fa fa-spin fa-circle-o-notch"></span>&nbsp;<spring:message code="notificacio.form.valid.document.validant"/></p>').insertAfter($file.closest(".fileinput"));
								...
								<div class="form-group">
									...
									<div class="controls col-xs-8">
										<div class="col-xs-6">
											...
											<spring:message code="es.caib.notib.logic.intf.dto.NotificaServeiTipusEnumDto.NORMAL" />
										</div>
										<div class="col-xs-6">
											<form:radiobutton path="enviaments[${j}].serveiTipus" value="URGENT" />
											<spring:message code="es.caib.notib.logic.intf.dto.NotificaServeiTipusEnumDto.URGENT" />
										</div>
									</div>
								</div>
							</div>
