...
<body>
	<table 
		...
		data-url="<c:url value="/servei/${servei.id}/permis/datatable"/>"
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								{{if organ}}
								<li><a href="../../servei/${servei.id}/organ/{{:organ}}/permis/{{:id}}" data-toggle="modal"><span class="fa fa-pencil"></span>&nbsp;&nbsp;<spring:message code="comu.boto.modificar"/></a></li>
								<li><a href="../../servei/${servei.id}/organ/{{:organ}}/permis/{{:id}}/delete" data-toggle="ajax" data-confirm="<spring:message code="procediment.permis.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
								{{else}}
								...
								<li><a href="../../servei/${servei.id}/permis/{{:id}}/delete" data-toggle="ajax" data-confirm="<spring:message code="procediment.permis.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
								{{/if}}
							</ul>
						</div>
						{{/if}}
