		...
		<div class="form-group<c:if test="${not empty campErrors}"> has-error</c:if>">
			...
			<div class="col-xs-${campInputSize}">
				<div class="fileinput fileinput-new input-group" style="width:100%" data-provides="fileinput">
					...
					<span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Selecciona</span><span class="fileinput-exists">Canviar</span><input type="file" id="${campPath}" name="${campPath}"></span>
