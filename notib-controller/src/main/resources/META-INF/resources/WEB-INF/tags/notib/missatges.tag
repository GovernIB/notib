...
<%
	request.setAttribute(
		"sessionErrors",
		session.getAttribute(es.caib.notib.back.helper.MissatgesHelper.SESSION_ATTRIBUTE_ERROR));
%>
...
<%
	request.setAttribute(
		"sessionWarnings",
		session.getAttribute(es.caib.notib.back.helper.MissatgesHelper.SESSION_ATTRIBUTE_WARNING));
%>
...
<%
	request.setAttribute(
		"sessionSuccesses",
		session.getAttribute(es.caib.notib.back.helper.MissatgesHelper.SESSION_ATTRIBUTE_SUCCESS));
%>
...
<%
	request.setAttribute(
		"sessionInfos",
		session.getAttribute(es.caib.notib.back.helper.MissatgesHelper.SESSION_ATTRIBUTE_INFO));
%>
