...
public class NotibBaseTest {
	...
	protected Notificacio_Type createNotificacio() throws DatatypeConfigurationException {
		...
		for(int i = 1; i < 3; i++) {
			...
			destinatari.setTitularLlinatge1("titularLlinatge1" + notificacioId + "_" + i);
			destinatari.setTitularLlinatge2("titularLlinatge2" + notificacioId + "_" + i);
			...
			destinatari.setDestinatariLlinatge1("destinatariLlinatge1_" + notificacioId + "_" + i);
			destinatari.setDestinatariLlinatge2("destinatariLlinatge2_" + notificacioId + "_" + i);
		...
		notificacio.getDestinataris().addAll(destinataris);
