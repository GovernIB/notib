 ...
 *       &lt;sequence>
 *         &lt;element name="emisorNif" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class EntregaDeh {
    ...
    protected String emisorNif;
    protected boolean obligat;
    protected String procedimentCodi;

    /**
     * Gets the value of the emisorNif property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the emisorNif property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setEmisorNif(String value) {
        this.emisorNif = value;
    }
