...
public class CertificacioApi {
    ...
    private Date data;
    @Schema(name = "origen", implementation = String.class, example = "carpeta",
    ...
    @Schema(name = "tamany", implementation = Integer.class, example = "4265384",
            description = "Mida de la certificació")
    private int tamany;
    @Schema(name = "hash", implementation = String.class, example = "00000000",
            description = "Hash de la certificació")
    private String hash;
    @Schema(name = "metadades", implementation = String.class, example = "00000000",
    ...
    private String csv;
    @Schema(name = "tipusMime", implementation = String.class, example = "application/pdf",
