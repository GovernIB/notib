...
public class PersonaApi {
    ...
    @Schema(name = "incapacitat", implementation = Boolean.class, example = "false", defaultValue = "false",
    ...
    @Size(max = 30)
    @Schema(name = "nom", implementation = String.class, example = "Joan",
    ...
    private String nom;
    @Size(max = 30)
    @Schema(name = "llinatge1", implementation = String.class, example = "Riera",
            description = "Primer llinatge de l’interessat\n" +
                    " * Obligatori en cas de persones físiques")
    private String llinatge1;
    @Size(max = 30)
    @Schema(name = "llinatge2", implementation = String.class, example = "Servera",
            description = "Segon llinatge de l’interessat")
    private String llinatge2;
    @Schema(name = "documentTipus", implementation = DocumentTipus.class, example = "PASSAPORT",
    ...
    @Size(max = 9)
    @Schema(name = "nif", implementation = String.class, example = "00000000T",
            description = "Número del document de l'interessat\n" +
                    " * Obligatori excepte per interessats tipus FISICA_SENSE_NIF")
    private String nif;
    @Size(max = 16)
    @Schema(name = "telefon", implementation = String.class, example = "678123456",
            description = "Telèfon de l’interessat\n" +
                    " * Actualment no s’utilitza")
    private String telefon;
    @Size(max = 160)
    @Schema(name = "email", implementation = String.class, example = "persona@correu.es",
            description = "Correu electrònic de l’interessat. \n" +
                    " * Altament recomanat el seu ús.")
    private String email;
    @Size(max = 80)
    @Schema(name = "raoSocial", implementation = String.class, example = "Amazon ltd.",
