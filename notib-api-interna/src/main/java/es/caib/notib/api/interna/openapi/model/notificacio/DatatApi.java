...
public class DatatApi {
    ...
    @Schema(name = "receptorNif", implementation = String.class, example = "00000000T",
            description = "Nif del receptor de la notificació")
    private String receptorNif;
    @Schema(name = "receptorNom", implementation = String.class, example = "Pep Riera",
    ...
    @Schema(name = "numSeguiment", implementation = String.class, example = "123456789",
