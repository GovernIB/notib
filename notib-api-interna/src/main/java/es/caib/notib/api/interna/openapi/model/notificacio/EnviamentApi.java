...
public class EnviamentApi {
    ...
    @Schema(name = "titular", implementation = PersonaApi.class, required = true,
            description = "Titular a qui s'adreça la notificació")
    private PersonaApi titular;
    @Schema(name = "destinataris", required = false,
    ...
    @Schema(name = "entregaPostal", implementation = EntregaPostalApi.class, required = false,
    ...
    @Schema(name = "entregaDeh", implementation = EntregaDehApi.class, required = false,
    ...
    @Schema(name = "serveiTipus", implementation = NotificaServeiTipusEnumDto.class, example = "NORMAL", required = false,
