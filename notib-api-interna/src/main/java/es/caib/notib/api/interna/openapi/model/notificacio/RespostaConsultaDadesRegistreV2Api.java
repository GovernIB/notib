...
public class RespostaConsultaDadesRegistreV2Api extends RespostaBaseApi {
    ...
    @Schema(name = "numRegistre", implementation = Integer.class, example = "1753",
    ...
    @Schema(name = "dataRegistre", implementation = Date.class, example = "2023-05-29T07:32:03.526+0000",
            description = "Data del registre")
    private Date dataRegistre;
    @Schema(name = "justificant",
    ...
    @Schema(name = "dataRecepcioSir", implementation = Date.class, example = "2023-05-29T07:32:03.526+0000",
            description = "En cas d'enviament SIR, data en que s'ha recepcionat el registre")
    private Date dataRecepcioSir;
    @Schema(name = "dataRegistreDestiSir", implementation = Date.class, example = "2023-05-29T07:32:03.526+0000",
