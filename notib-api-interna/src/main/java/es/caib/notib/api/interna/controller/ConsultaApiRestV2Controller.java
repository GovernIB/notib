...
import es.caib.notib.api.interna.helper.CaseInsensitiveEnumEditor;
...
@Api(value = "/consulta/v2", description = "API de consulta de comunicacions i notificacions v2")
