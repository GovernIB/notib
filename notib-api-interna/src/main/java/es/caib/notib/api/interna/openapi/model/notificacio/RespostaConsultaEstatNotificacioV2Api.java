...
public class RespostaConsultaEstatNotificacioV2Api extends RespostaBaseApi {
    ...
    @Schema(name = "estat", implementation = NotificacioEstatEnum.class, example = "FINALITZADA",
            description = "Enumerat amb la informació de l'estat de l'enviament")
    private NotificacioEstatEnum estat;
    @Schema(name = "tipus", implementation = String.class, example = "NOTIFICACIO",
            description = "Indica si l’enviament és una comunicació o una notificació")
    private String tipus;
    @Schema(name = "emisorDir3", implementation = String.class, example = "A04003003",
            description = "Codi Dir3 de l’organisme emisor" +
                    "\n(Entitat de Notib)")
    private String emisorDir3;
    @Schema(name = "procediment", implementation = ProcedimentApi.class,
            description = "Procediment al que pertany la notificació")
    private Procediment procediment;
    @Schema(name = "organGestorDir3", implementation = String.class, example = "A04035965",
    ...
    @Schema(name = "dataCreada", implementation = Date.class, example = "2023-05-29T07:32:03.526+0000",
            description = "Data en que s'ha donat d'alta la notificació")
    private Date dataCreada;
    @Schema(name = "dataEnviada", implementation = Date.class, example = "2023-05-29T07:32:03.526+0000",
