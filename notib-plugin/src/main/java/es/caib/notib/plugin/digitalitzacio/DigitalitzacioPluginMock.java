...
public class DigitalitzacioPluginMock extends AbstractSalutPlugin implements DigitalitzacioPlugin {
	...
	public List<DigitalitzacioPerfil> recuperarPerfilsDisponibles(String idioma) throws SistemaExternException {
		...
		dp1.setCodi("DP1");dp1.setNom("Perfil digitalització 1");
        dp1.setDescripcio("Descripció del perfil digitalització 1");
        dp1.setTipus(1);
		var dp2 = new DigitalitzacioPerfil();
		dp2.setCodi("DP2");dp2.setNom("Perfil digitalització 2");
        dp2.setDescripcio("Descripció del perfil digitalització 2");
        dp2.setTipus(2);
		var dp3 = new DigitalitzacioPerfil();
		dp3.setCodi("DP3");
        dp3.setNom("Perfil digitalització 3");
        dp3.setDescripcio("Descripció del perfil digitalització 3");
        dp3.setTipus(3);
		var dp4 = new DigitalitzacioPerfil();
		dp4.setCodi("DP4");
        dp4.setNom("Perfil digitalització 4");
        dp4.setDescripcio("Descripció del perfil digitalització 4");
        dp4.setTipus(4);
		var dp5 = new DigitalitzacioPerfil();
		dp5.setCodi("DP5");
        dp5.setNom("Perfil digitalització 5");
        dp5.setDescripcio("Descripció del perfil digitalització 5");
        dp5.setTipus(5);
