...
public class EnviamentFiltreCommand extends FiltreCommand {
	...
	public static EnviamentFiltreCommand asCommand(NotificacioEnviamentFiltreDto dto) {
		return ConversioTipusHelper.convertir(dto, EnviamentFiltreCommand.class);
	}
	public static NotificacioEnviamentFiltreDto asDto(EnviamentFiltreCommand command) {
