...
public class SpringBootSecurityConfig extends BaseWebSecurityConfig {
	...
	@Value("${es.caib.notib.security.resourceAcces.api-interna:#{null}}")
	...
	public SecurityFilterChain basicAuthSecurityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeRequests((authz) -> authz.antMatchers(AUTH_WHITELIST)
				.permitAll()
