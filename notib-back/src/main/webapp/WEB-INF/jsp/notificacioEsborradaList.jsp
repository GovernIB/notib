...
<c:url var="urlDatatable" value="/notificacio/datatable" scope="request"/>


<html>
<head>
	<title><spring:message code="notificacio.list.esborrades.titol"/></title>
...
<body>
<div id="msg-box"></div>
	<c:import url="includes/notificacioEsborradaList.jsp"/>
</body>
</html>
