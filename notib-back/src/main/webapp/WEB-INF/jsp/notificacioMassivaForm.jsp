...
<div class="alert alert-info">
	...
	<c:set var="csvInfo"><spring:message code="notificacio.massiva.form.camp.arxiuCsv.avis"/> ${maxFiles}.</c:set>
	<form:form action="${formAction}" id="form" method="post" cssClass="form-horizontal" modelAttribute="notificacioMassivaCommand" enctype="multipart/form-data">
		...
		<not:inputFile name="ficheroCsv" textKey="notificacio.massiva.form.camp.arxiuCsv" labelSize="2" inputSize="10"
					   required="true" info="true" messageInfo="${csvInfo}"
		...
		<not:inputFile name="ficheroZip" textKey="notificacio.massiva.form.camp.arxiuZip" labelSize="2" inputSize="10"
					   required="false" info="true" messageKey="notificacio.massiva.form.camp.arxiuZip.avis"
