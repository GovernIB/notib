...
<html>
<head>
	<title><spring:message code="servei.grup.titol"/></title>
...
<body>
	<table 
		...
		data-url="<c:url value="/servei/${servei.id}/grup/datatable"/>"
					...
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="grup/{{:id}}/delete" data-toggle="ajax" data-confirm="<spring:message code="servei.grup.confirmacio.esborrar"/>"><span class="fa fa-trash-o"></span>&nbsp;&nbsp;<spring:message code="comu.boto.esborrar"/></a></li>
							</ul>
						</div>
					</script>
				</th>
	...
	<script id="tableButtonsTemplate" type="text/x-jsrender">
		<p style="text-align:right"><a class="btn btn-default" href="../../servei/${servei.id}/grup/new" data-height="300px" data-toggle="modal"><span class="fa fa-plus"></span>&nbsp;<spring:message code="servei.grup.boto.nou.grup"/></a></p>
	</script>
	<c:if test="${!isRolActualAdministradorLectura}">
