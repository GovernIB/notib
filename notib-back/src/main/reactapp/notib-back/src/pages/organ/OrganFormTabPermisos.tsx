...
const OrganFormTabPermisosFormContent: React.FC = () => {
    ...
    return <Grid container spacing={2}>
        ...
        <Grid size={12}><FormField name="perm0Allowed" label={t('page.organs.form.permisos.administrador')} /></Grid>
        <Grid size={12}><FormField name="perm2Allowed" label={t('page.organs.form.permisos.consulta')} /></Grid>
        <Grid size={12}><FormField name="permXAllowed" label={t('page.organs.form.permisos.processar')} /></Grid>
        <Grid size={12}><FormField name="perm3Allowed" label={t('page.organs.form.permisos.gestio')} /></Grid>
        <Grid size={12}><FormField name="perm3Allowed" label={t('page.organs.form.permisos.comuns')} /></Grid>
        <Grid size={12}><FormField name="perm3Allowed" label={t('page.organs.form.permisos.notificacions')} /></Grid>
        <Grid size={12}><FormField name="perm3Allowed" label={t('page.organs.form.permisos.comunicacions')} /></Grid>
        <Grid size={12}><FormField name="perm3Allowed" label={t('page.organs.form.permisos.sir')} /></Grid>
        <Grid size={12}><FormField name="perm3Allowed" label={t('page.organs.form.permisos.comSenseProc')} /></Grid>
    </Grid>;
}
...
const OrganFormTabPermisos: React.FC = () => {
    ...
    return <MuiDataGrid
        ...
        formAdditionalData={{ sidGrantedAuthority: false, resourceName: 'organGestorResource', resourceId: id }}
        paginationActive
        //density="standard"
