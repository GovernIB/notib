...
const PermissionForm: React.FC = () => {
    ...
    //     {
    //         value: false,
    //         label: t('component.PermissionGrid.grantedAuthority.user'),
    //     },
    //     {
    //         value: true,
    //         label: t('component.PermissionGrid.grantedAuthority.role'),
    //     },
    // ];
    return (
...
//             filterBuilder.eq('sidGrantedAuthority', `'${data?.tipus === 'ROL'}'`),
