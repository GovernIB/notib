import { Box, Button, Chip, Grid, Icon, Menu, MenuItem } from '@mui/material';
...
const AccionsMassives: React.FC<AccionsMassivesProps> = (props) => {
    ...
    const { options, buttonLabel = t('component.AccionsMassives.labelBoto'), sizeSelection } = props;
            ...
            <Grid>
                ...
                >
                    <Box sx={{ display: 'flex', gap: 1, justifyContent: 'space-between' }}>
                        <Chip label={sizeSelection} size="small" color="primary" />
                        {buttonLabel}
                    </Box>
                </Button>
                <Menu
