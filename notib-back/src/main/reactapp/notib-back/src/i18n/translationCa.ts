            ...
            detail: {
                ...
                tab: {
                    ...
                    entregaPostal: {
                        ...
                        cieEstat: "Estat",
                        cieEstatPendent: "L'entrega postal no ha estat enviada o s'ha enviat amb errors. Veure pestanya d'events per més informació",
                    ...
                    stateMachine: {
                        title: "State Machine",
                        missatge: "Atenció! No alterar els estats de la state machine ni enviar events si no es coneixen les repercusions que poden tenir aquetes accions." +
