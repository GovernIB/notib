...
INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE, POSITION) VALUES ('es.caib.notib.plugin.comanda.url', '', 'URL del plugin de Comanda', 'COMANDA', 1, 'TEXT', 0, '1');
