...
--------------------------------------------------------
  ...
  ALTER TABLE "NOT_NOTIFICACIO" MODIFY ("GRUP_CODI" NOT NULL ENABLE);
 
  ALTER TABLE "NOT_NOTIFICACIO" MODIFY ("REGISTRE_NUM_EXPEDIENT" NOT NULL ENABLE);
  ...
  ALTER TABLE "NOT_NOTIFICACIO" MODIFY ("PAGADOR_CIE_ID" NOT NULL ENABLE);
 
  ALTER TABLE "NOT_NOTIFICACIO" MODIFY ("PAGADOR_POSTAL_ID" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "NOT_PERSONA" MODIFY ("NOTIFICACIO_ENV_ID" NOT NULL ENABLE);
