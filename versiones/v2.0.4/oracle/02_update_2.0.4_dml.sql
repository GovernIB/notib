...
INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.log.tipus.EFICIENCIA_TAULA_REMESES', 'false', 'Mostrar logs de la eficiencia dels metodes', 'LOGS', 17, 0, 'BOOL', 0);-- #883
