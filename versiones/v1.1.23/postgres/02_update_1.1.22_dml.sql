...
INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugin.carpeta.url', 'https://se.caib.es/carpetaapi/interna/secure/mobilenotification/sendnotificationtomobile','Url on es troba la API de la Carpeta', 'CARPETA', 1, 1, 'TEXT', 1);
