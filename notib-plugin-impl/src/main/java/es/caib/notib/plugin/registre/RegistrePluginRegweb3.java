...
import es.caib.notib.core.api.registre.RegistreAnnex;
import es.caib.notib.core.api.registre.RegistreAnotacio;
import es.caib.notib.core.api.registre.RegistreInteressat;
import es.caib.notib.core.api.registre.RegistreTipusEnum;
...
public class RegistrePluginRegweb3 implements RegistrePlugin {
	...
	private String getBaseUrl() {
		return PropertiesHelper.getProperties().getProperty(
				"es.caib.notib.plugin.registre.regweb3.base.url");
	}
	private String getUsername() {
		return PropertiesHelper.getProperties().getProperty(
				"es.caib.notib.plugin.registre.regweb3.username");
	}
	private String getPassword() {
		return PropertiesHelper.getProperties().getProperty(
				"es.caib.notib.plugin.registre.regweb3.password");
	}
	private String getRequestUser() {
		return PropertiesHelper.getProperties().getProperty(
				"es.caib.notib.plugin.registre.regweb3.request.user");
	}
	private boolean isLogMissatgesActiu() {
		return PropertiesHelper.getProperties().getAsBoolean(
				"es.caib.notib.plugin.registre.regweb3.log.actiu");
	}
