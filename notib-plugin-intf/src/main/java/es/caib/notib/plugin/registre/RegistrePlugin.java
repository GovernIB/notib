...
//			String aplicacion) throws RegistrePluginException;
	 ...
	 * @throws RegistrePluginException
	 */
	RespostaConsultaRegistre salidaAsientoRegistral(String codiDir3Entitat, AsientoRegistralBeanDto arb, Long tipusOperacio, boolean generarJustificant);
	 ...
	 * @throws RegistrePluginException
	 */
	RespostaConsultaRegistre obtenerAsientoRegistral(String codiDir3Entitat, String numeroRegistreFormatat, Long tipusOperacio, boolean ambAnnexos);
	 ...
	 * @throws RegistrePluginException
	 */
	RespostaJustificantRecepcio obtenerJustificante(String codiDir3Entitat, String numeroRegistreFormatat, long tipusRegistre);
	 ...
	 * @throws RegistrePluginException
	 */
	RespostaJustificantRecepcio obtenerOficioExterno(String codiDir3Entitat, String numeroRegistreFormatat);
	 ...
	 * @return Llistat dels tipus d'assumpte
	 * @throws RegistrePluginException
	 */
	 ...
	 * @return Retorna una llista dels codis d'assumpte
	 * @throws RegistrePluginException
	 */
	List<CodiAssumpte> llistarCodisAssumpte(String entitatCodi, String tipusAssumpte) throws RegistrePluginException;
	 ...
	 * @return Retorna una llista amb les oficines de l'entitat
	 * @throws RegistrePluginException 
	 */
	Oficina llistarOficinaVirtual(String entitatCodi, String nomOficinaVirtual, Long autoritzacioValor) throws RegistrePluginException;
	 ...
	 * @throws RegistrePluginException 
	 */
	List<Oficina> llistarOficines(String entitatCodi, Long autoritzacioValor) throws RegistrePluginException;
	 ...
	 * @throws RegistrePluginException 
	 */
	List<Llibre> llistarLlibres(String entitatCodi, String oficina, Long autoritzacioValor) throws RegistrePluginException;
	 ...
	 * @return Una llista de les oficines i els seus llibres
	 * @throws RegistrePluginException 
	 */
	List<LlibreOficina> llistarLlibresOficines(String entitatCodi, String usuariCodi, Long tipusRegistre);
	 ...
	 * @return El llibre de l'organisme
	 * @throws RegistrePluginException 
	 */
	Llibre llistarLlibreOrganisme(String entitatCodi, String organismeCodi) throws RegistrePluginException;
	
	/**
	 * Llista els òrgans d'una entitat
	 * 
	 * @param entitatCodi Codi de l'entitat de la qual es volen llistar els organismes
	 * @return Retorna una llista dels organismes d'una entitat
	 * @throws RegistrePluginException 
	 */
	List<Organisme> llistarOrganismes(String entitatCodi) throws RegistrePluginException;
