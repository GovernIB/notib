...
public class ValidacionCadenaInfo {
    ...
    protected List<ErrorCertificado> errorCertificado;
     ...
     * {@link ErrorCertificado }
     * 
     * 
     */
    public List<ErrorCertificado> getErrorCertificado() {
        if (errorCertificado == null) {
            errorCertificado = new ArrayList<ErrorCertificado>();
        }
