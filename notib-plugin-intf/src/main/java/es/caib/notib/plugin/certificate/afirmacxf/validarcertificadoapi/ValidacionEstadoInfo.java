...
package es.caib.notib.plugin.certificate.afirmacxf.validarcertificadoapi;
...
public class ValidacionEstadoInfo {
    ...
    protected List<InfoMetodoVerificacion> infoMetodoVerificacion;
     ...
     * {@link InfoMetodoVerificacion }
     * 
     * 
     */
    public List<InfoMetodoVerificacion> getInfoMetodoVerificacion() {
        if (infoMetodoVerificacion == null) {
            infoMetodoVerificacion = new ArrayList<InfoMetodoVerificacion>();
        }
    ...
    public static class InfoMetodoVerificacion {
         ...
         *     
         */
        public void setMetodo(Metodo value) {
            this.metodo = value;
        }
