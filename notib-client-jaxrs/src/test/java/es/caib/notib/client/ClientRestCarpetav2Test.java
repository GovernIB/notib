...
//		System.setProperty("javax.net.ssl.trustStorePassword", "tecnologies");
	...
	public void testNotificacioByTitularVisibleCat() throws Exception {
		...
		assertTrue(resposta.getNumeroElementsTotals() > 0, "No s'han trobat resultats");
		assertTrue(resposta.getNumeroElementsRetornats() > 0, "La pàgina és buida");
		assertNotNull(resposta.getResultat(), "No ha retornat resultats");
		assertEquals(resposta.getNumeroElementsRetornats(), resposta.getResultat().size(), "No coincideix el nombre de");
