...
public class EntityComprovarHelperIT extends BaseServiceTestV2 {
    ...
    public void setUp() throws Exception {
        ...
        database = createDatabase(EntitatItemTest.getRandomInstance(), organGestorCreator, procedimentCreator, notificacioCreator);
    }

    @After
    public final void tearDown() {
        destroyDatabase(database.getEntitat().getId(), notificacioCreator, procedimentCreator, organGestorCreator);
    }
    ...
    public void whenHasOrganGestor() throws Exception {
        ...
        var organGestor = (OrganGestorDto) database.get("organGestorProves");
        var organGestorEntity = organGestorRepository.findById(organGestor.getId()).orElseThrow();
        ...
        organGestorService.permisUpdate(database.getEntitat().getId(), organGestorEntity.getId(), false, permis);
