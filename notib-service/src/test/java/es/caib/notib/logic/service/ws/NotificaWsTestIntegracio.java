...
//import es.caib.notib.logic.intf.dto.NotificaDomiciliConcretTipusEnumDto;
...
//import es.caib.notib.logic.intf.ws.notificacio.EntregaPostalTipusEnum;
...
//	}
	...
	public NotificacioTest generarNotificacio(
		...
		notificacio.getDocument().setHash(Base64.getEncoder().encodeToString(
				Hex.decodeHex(
