...
//    @Mapping(source = "documentTipus", target = "tipoDocumentoIdentificacion", qualifiedByName = "tipoDocumento")
    @Mapping(source = "documentTipus", target = "tipoDocumentoIdentificacion")
