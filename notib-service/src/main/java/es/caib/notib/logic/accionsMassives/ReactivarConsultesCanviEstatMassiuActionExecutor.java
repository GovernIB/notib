...
@Slf4j
@AllArgsConstructor
public class ReactivarConsultesCanviEstatMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, AccioMassivaParams, RespostaActionExecutor> {
