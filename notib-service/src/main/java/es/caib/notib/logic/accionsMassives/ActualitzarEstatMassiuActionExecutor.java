...
@Slf4j
@AllArgsConstructor
public class ActualitzarEstatMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, AccioMassivaParams , RespostaActionExecutor> {
