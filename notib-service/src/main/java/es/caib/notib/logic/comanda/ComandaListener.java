...
//            var requestBody = mapper.writeValueAsString(tasca);
    ...
    public void enviarTasca(NotificacioEnviamentEntity enviament) {
        ...
        try {
            ...
            var estat = EnviamentTipus.SIR.equals(notificacio.getEnviamentTipus()) ? enviament.getRegistreEstat().name() : enviament.getNotificaEstat().name();
            ...
            log.error("[crearTascaNotificaPendent] Error enviant la tasca " );
        }
    }
}
