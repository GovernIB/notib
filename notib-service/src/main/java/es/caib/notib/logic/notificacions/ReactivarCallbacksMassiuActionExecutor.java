...
@Slf4j
@AllArgsConstructor
public class ReactivarCallbacksMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, NotificacioResource.AccioMassivaParams, RespostaActionExecutor> {
	...
	public RespostaActionExecutor exec(String code, NotificacioResourceEntity entity, NotificacioResource.AccioMassivaParams params) throws ActionExecutionException {
		...
		try {
			...
			var accio = AccioMassivaExecucio.builder()
							...
							.tipus(AccioMassivaTipus.TORNA_ACTIVAR_CALLBACK)
			...
			var msg = "Error inesperat al reactivar els enviaments de callbacks";
			log.error("[ReactivarCallbacksMassiuActionExecutor] " + msg);
