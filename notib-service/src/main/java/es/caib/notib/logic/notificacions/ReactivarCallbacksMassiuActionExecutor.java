...
@Slf4j
@AllArgsConstructor
public class ReactivarCallbacksMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, AccioMassivaParams, RespostaActionExecutor> {
