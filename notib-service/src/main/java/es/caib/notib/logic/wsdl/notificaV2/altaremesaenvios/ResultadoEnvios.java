...
/**
 * <p>Java class for ResultadoEnvios complex type.
 * 
...
public class ResultadoEnvios {
    ...
    protected List<es.caib.notib.logic.wsdl.notificaV2.altaremesaenvios.ResultadoEnvio> item;
     ...
     * {@link es.caib.notib.logic.wsdl.notificaV2.altaremesaenvios.ResultadoEnvio }
     * 
     * 
     */
    public List<es.caib.notib.logic.wsdl.notificaV2.altaremesaenvios.ResultadoEnvio> getItem() {
        if (item == null) {
