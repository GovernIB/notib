...
@Slf4j
@AllArgsConstructor
public class ProcedimentActivarActionExecutor implements BaseMutableResourceService.ActionExecutor<ProcedimentResourceEntity, Serializable, Boolean> {
	...
	public Boolean exec(String code, ProcedimentResourceEntity entity, Serializable params) throws ActionExecutionException {
		...
		try {
			procedimentService.updateActiu(entity.getId(), true);
			return true;
		} catch (Exception ex) {
