...
@Slf4j
@Service
public class GrupResourceServiceImpl
	extends BaseAdminEntitatResourceServiceImpl<GrupResource, GrupResourceEntity>
	implements GrupResourceService {

	public GrupResourceServiceImpl(
