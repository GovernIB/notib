...
@Slf4j
@AllArgsConstructor
public class ReactivarConsultesCanviEstatMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, NotificacioResource.AccioMassivaParams, RespostaActionExecutor> {
	...
	public RespostaActionExecutor exec(String code, NotificacioResourceEntity entity, NotificacioResource.AccioMassivaParams params) throws ActionExecutionException {
		...
		try {
			...
			var accio = AccioMassivaExecucio.builder()
							...
							.tipus(AccioMassivaTipus.TORNA_ACTIVAR_CONSULTES_CANVI_ESTAT)
			...
			var msg = "Error inesperat reactivar les consultes de canvi d'estat";
			log.error("[ReactivarConsultesCanviEstatMassiuActionExecutor] " + msg);
