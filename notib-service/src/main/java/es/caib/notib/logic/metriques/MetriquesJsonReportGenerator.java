...
public class MetriquesJsonReportGenerator implements BaseReadonlyResourceService.ReportGenerator<MetriquesResourceEntity, Serializable, MetriquesResource> {

	private final AplicacioService aplicacioService;

	@Override
	public List<MetriquesResource> generateData(String code, MetriquesResourceEntity entity, Serializable params) throws ReportGenerationException {
		return List.of();
	}
	...
	public DownloadableFile generateFile(String code, List<?> data, ReportFileType fileType, OutputStream out) {
		...
		try {
			var metrics = aplicacioService.getMetrics();
