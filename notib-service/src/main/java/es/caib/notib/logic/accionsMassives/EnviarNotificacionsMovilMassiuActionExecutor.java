...
//		}
		try {
			...
			var accio = AccioMassivaExecucio.builder()
							...
							.tipus(AccioMassivaTipus.ENVIAR_NOT_MOVIL)
			...
			var msg = "Error inesperat al enviar les notificacions movil";
			log.error("[EnviarNotificacionsMovilMassiuActionExecutor] " + msg);
