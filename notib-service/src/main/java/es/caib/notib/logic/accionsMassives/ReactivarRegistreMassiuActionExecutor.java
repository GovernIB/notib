...
@Slf4j
@AllArgsConstructor
public class ReactivarRegistreMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, NotificacioResource.AccioMassivaParams, RespostaActionExecutor> {
	...
	public RespostaActionExecutor exec(String code, NotificacioResourceEntity entity, NotificacioResource.AccioMassivaParams params) throws ActionExecutionException {
		...
		try {
			...
			var accio = AccioMassivaExecucio.builder()
							...
							.tipus(AccioMassivaTipus.REACTIVAR_REGISTRE)
			...
			var msg = "Error inesperat al reactivant l'enviament a registre";
			log.error("[RespostaActionExecutor] " + msg);
