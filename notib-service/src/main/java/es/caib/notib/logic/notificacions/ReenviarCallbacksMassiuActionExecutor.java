...
@Slf4j
@AllArgsConstructor
public class ReenviarCallbacksMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, AccioMassivaParams, RespostaActionExecutor> {
	...
	public RespostaActionExecutor exec(String code, NotificacioResourceEntity entity, AccioMassivaParams params) throws ActionExecutionException {
		...
		try {
			...
			var accio = AccioMassivaExecucio.builder()
							...
							.tipus(AccioMassivaTipus.ENVIAR_CALLBACK)
			...
			var msg = "Error inesperat al enviant els callbacks";
			log.error("[ReenviarCallbacksMassiuActionExecutor] " + msg);
