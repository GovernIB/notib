...
@Slf4j
@AllArgsConstructor
public class AnularMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, AnularDto, RespostaActionExecutor> {
	...
	@Override
	public RespostaActionExecutor exec(String code, NotificacioResourceEntity entity, AnularDto params) throws ActionExecutionException {
		...
		try {
			...
			var msg = "Error inesperat anulat massiu";
			log.error("[AnularMassiuActionExecutor] " + msg);
			throw new ActionExecutionException(NotificacioResource.class, null, "-1", msg + ": " + ex.getMessage());
		}
	}

	@Override
	public void onChange(Serializable id, AnularDto previous, String fieldName, Object fieldValue, Map answers, String[] previousFieldNames, AnularDto target) {
