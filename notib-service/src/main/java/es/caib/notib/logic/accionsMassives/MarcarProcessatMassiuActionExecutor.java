...
@Slf4j
@AllArgsConstructor
public class MarcarProcessatMassiuActionExecutor implements BaseMutableResourceService.ActionExecutor<NotificacioResourceEntity, MarcarProcessat, RespostaActionExecutor> {
	...
	@Override
	public void onChange(Serializable id, MarcarProcessat previous, String fieldName, Object fieldValue, Map answers, String[] previousFieldNames, MarcarProcessat target) {
