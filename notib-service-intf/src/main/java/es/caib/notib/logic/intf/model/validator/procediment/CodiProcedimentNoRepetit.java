...
public class CodiProcedimentNoRepetit implements CustomValidator<ProcedimentResource>  {
	...
	public boolean validate(ProcedimentResource resource, ConstraintValidatorContext context) {
		return procedimentResourceService.validarCodiNoRepetit(resource.getId(), resource.getCodi());
	}
}
