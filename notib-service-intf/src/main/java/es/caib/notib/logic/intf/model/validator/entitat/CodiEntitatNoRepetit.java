...
public class CodiEntitatNoRepetit implements CustomValidator<EntitatResource>  {
	...
	public boolean validate(EntitatResource resource, ConstraintValidatorContext context) {
		return entitatResourceService.validarCodiNoRepetit(resource.getId(), resource.getCodi());
	}
}
