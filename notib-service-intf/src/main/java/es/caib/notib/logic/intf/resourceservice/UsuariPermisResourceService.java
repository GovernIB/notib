...
/**
 * Definició del servei de consulta de permisos d'usuari
 *
 * @author Límit Tecnologies
 */
public interface UsuariPermisResourceService extends ReadonlyResourceService<UsuariPermisResource, String> {
}
