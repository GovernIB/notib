...
CREATE TABLE NOT_ACL_SID (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, PRINCIPAL BOOLEAN NOT NULL, SID VARCHAR(100) NOT NULL, CONSTRAINT NOT_ACL_SID_PK PRIMARY KEY (ID));

-- Changeset db/changelog/initial_schema_table.yaml::init-table-2::limit (generated)
CREATE TABLE NOT_ACL_OBJECT_IDENTITY (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, OBJECT_ID_CLASS BIGINT NOT NULL, OBJECT_ID_IDENTITY BIGINT NOT NULL, PARENT_OBJECT BIGINT, OWNER_SID BIGINT NOT NULL, ENTRIES_INHERITING BOOLEAN NOT NULL, CONSTRAINT NOT_ACL_OBJECT_IDENTITY_PK PRIMARY KEY (ID));

-- Changeset db/changelog/initial_schema_table.yaml::init-table-3::limit (generated)
CREATE TABLE NOT_ACL_ENTRY (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, ACL_OBJECT_IDENTITY BIGINT NOT NULL, ACE_ORDER BIGINT NOT NULL, SID BIGINT NOT NULL, MASK BIGINT NOT NULL, GRANTING BOOLEAN NOT NULL, AUDIT_SUCCESS BOOLEAN NOT NULL, AUDIT_FAILURE BOOLEAN NOT NULL, CONSTRAINT NOT_ACL_ENTRY_PK PRIMARY KEY (ID));

-- Changeset db/changelog/initial_schema_table.yaml::init-table-4::limit (generated)
CREATE TABLE NOT_ACL_CLASS (ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, CLASS VARCHAR(100) NOT NULL, CONSTRAINT NOT_ACL_CLASS_PK PRIMARY KEY (ID));
...
CREATE TABLE NOT_PROCESSOS_INICIALS (ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, CODI VARCHAR(100) NOT NULL, INIT BOOLEAN NOT NULL, CONSTRAINT NOT_PROCESSOS_INICIALS_PK PRIMARY KEY (ID));
...
CREATE TABLE NOT_CALLBACK (ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, USUARI_CODI VARCHAR(64) NOT NULL, NOTIFICACIO_ID numeric NOT NULL, ENVIAMENT_ID numeric NOT NULL, DATA TIMESTAMP(6) WITHOUT TIME ZONE, ERROR BOOLEAN DEFAULT FALSE NOT NULL, ERROR_DESC VARCHAR(2048), ESTAT VARCHAR(10), INTENTS INTEGER DEFAULT 0 NOT NULL, CONSTRAINT NOT_CALLBACK_PK PRIMARY KEY (ID), UNIQUE (ENVIAMENT_ID));
...
CREATE TABLE NOT_MON_INT (ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, CODI VARCHAR(100) NOT NULL, data TIMESTAMP(6) WITHOUT TIME ZONE, descripcio VARCHAR(1024), tipus VARCHAR(10), aplicacio VARCHAR(64), temps_resposta numeric, estat VARCHAR(5), codi_usuari VARCHAR(64), codi_entitat VARCHAR(64), error_descripcio VARCHAR(1024), excepcio_msg VARCHAR(1024), excepcio_stacktrace VARCHAR(2048), CONSTRAINT NOT_MON_INT_PK PRIMARY KEY (ID));

CREATE TABLE NOT_MON_INT_PARAM (ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, MON_INT_ID INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, codi VARCHAR(64) NOT NULL, valor VARCHAR(1024), CONSTRAINT NOT_MON_INT_PARAM_PK PRIMARY KEY (ID));
...
INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) values ('es.caib.notib.plugin.validatesignature.class','org.fundaciobit.plugins.validatesignature.afirmacxf.AfirmaCxfValidateSignaturePlugin','Classe del plugin','VALIDATE_SIGNATURE',0,false,'VALSIG_CLASS',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) values ('es.caib.notib.plugins.validatesignature.afirmacxf.endpoint',null,'Endpoint de AfirmaCxf','VALIDATE_SIGNATURE',1,true,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) values ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.username',null,'Usuari de AfirmaCxf','VALIDATE_SIGNATURE',2,true,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) values ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.password',null,'Password de AfirmaCxf','VALIDATE_SIGNATURE',3,true,'PASSWORD',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) values ('es.caib.notib.plugins.validatesignature.afirmacxf.applicationID','CAIBDEV2.RIPEA','ID de l’aplicació','VALIDATE_SIGNATURE',4,false,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.ignoreservercertificates', 'true', 'Ignorar els certificats', 'VALIDATE_SIGNATURE',5,false,'BOOL',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.TransformersTemplatesPath', null, 'Path dels transformers', 'VALIDATE_SIGNATURE',6,true,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.ks.path', null, 'Path del magatzem de claus amb el certificat per l''autenticació a Afirm@', 'VALIDATE_SIGNATURE',7,true,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.ks.type', null, 'Tipus de magatzem de claus per l''autenticació a Afirm@', 'VALIDATE_SIGNATURE',8,true,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.ks.password', null, 'Password del magatzem de claus per l''autenticació a Afirm@', 'VALIDATE_SIGNATURE',9,true,'PASSWORD',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.ks.cert.alias', null, 'Alies del certificat a emprar del magatzem de claus per l''autenticació a Afirm@', 'VALIDATE_SIGNATURE',10,true,'TEXT',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.afirmacxf.authorization.ks.cert.password', null, 'Password del certificat del magatzem de claus per l''autenticació a Afirm@', 'VALIDATE_SIGNATURE',11,true,'PASSWORD',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.enable.web', 'true', 'Habilitar validació de signatura de documents en peticions via WEB','VALIDATE_SIGNATURE',12,false,'BOOL',true);

INSERT INTO NOT_CONFIG (KEY, VALUE, DESCRIPTION, GROUP_CODE, POSITION, JBOSS_PROPERTY, TYPE_CODE, CONFIGURABLE) VALUES ('es.caib.notib.plugins.validatesignature.enable.rest', 'true', 'Habilitar validació de signatura de documents en peticions via REST','VALIDATE_SIGNATURE',13,false,'BOOL',true);

UPDATE NOT_PROCESSOS_INICIALS SET INIT = true WHERE codi = 'PROPIETATS_CONFIG_ENTITATS';
