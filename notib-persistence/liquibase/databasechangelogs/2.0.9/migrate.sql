...
UPDATE NOT_NOTIFICACIO_table n SET n.organ_gestor = (SELECT o.id FROM NOT_ORGAN_GESTOR o JOIN NOT_PROCEDIMENT p ON p.ORGAN_GESTOR = o.id WHERE p.id = n.procediment_id) WHERE n.ORGAN_GESTOR IS NULL;
