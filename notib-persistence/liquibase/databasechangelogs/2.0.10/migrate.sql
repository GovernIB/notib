...
ALTER TABLE not_callback ADD data_creacio TIMESTAMP(6);

ALTER TABLE not_callback ADD ultim_intent TIMESTAMP(6);

ALTER TABLE not_callback ADD pausat NUMBER(1) DEFAULT '0';

update not_callback set data_creacio = data;

-- Changeset db/changelog/changes/2.0.10/explotacio.yaml::17458513344726::limit
CREATE TABLE not_explot_env_info (id NUMBER(38, 0) NOT NULL, entitat_id NUMBER(38, 0) NOT NULL, procediment_id NUMBER(38, 0), organ_gestor_codi VARCHAR2(64 CHAR) NOT NULL, usuari_codi VARCHAR2(64 CHAR), enviament_tipus VARCHAR2(16 CHAR) NOT NULL, origen VARCHAR2(16 CHAR) NOT NULL, data_creacio TIMESTAMP NOT NULL, temps_pendent NUMBER(38, 0), data_reg_env_error TIMESTAMP, intents_reg_enviament INTEGER, data_registrada TIMESTAMP, temps_registrada NUMBER(38, 0), intents_sir_consulta INTEGER, data_reg_acceptada TIMESTAMP, data_reg_rebutjada TIMESTAMP, data_not_enviament_error TIMESTAMP, intents_not_enviament INTEGER, data_not_enviada TIMESTAMP, temps_not_enviada NUMBER(38, 0), data_not_notificada TIMESTAMP, data_not_rebutjada TIMESTAMP, data_not_expirada TIMESTAMP, data_not_error TIMESTAMP, data_cie_enviament_error TIMESTAMP, intents_cie_enviament INTEGER, data_cie_enviada TIMESTAMP, temps_cie_enviada NUMBER(38, 0), data_cie_notificada TIMESTAMP, data_cie_rebutjada TIMESTAMP, data_cie_cancelada TIMESTAMP, data_cie_error TIMESTAMP, data_email_enviament_error TIMESTAMP, intents_email_enviament INTEGER, data_email_enviada TIMESTAMP, temps_total NUMBER(38, 0), enviament_id NUMBER(38, 0) NOT NULL, CONSTRAINT PK_NOT_EXPLOT_ENV_INFO PRIMARY KEY (id));
...
-- Changeset db/changelog/changes/2.0.10/explotacio.yaml::17458513344727::limit
...
ALTER TABLE not_explot_fet ADD tmp_reg_eml NUMBER(38, 0);
...
-- Changeset db/changelog/changes/2.0.10/explotacio2.yaml::17458513344826::limit
ALTER TABLE not_explot_env_info ADD entitat_id NUMBER(38, 0);

ALTER TABLE not_explot_env_info ADD procediment_id NUMBER(38, 0);

ALTER TABLE not_explot_env_info ADD organ_gestor_codi VARCHAR2(64 CHAR);

ALTER TABLE not_explot_env_info ADD usuari_codi VARCHAR2(64 CHAR);

ALTER TABLE not_explot_env_info ADD enviament_tipus VARCHAR2(16 CHAR);

ALTER TABLE not_explot_env_info ADD origen VARCHAR2(16 CHAR);

-- Changeset db/changelog/changes/2.0.10/explotacio2.yaml::17458513344827::limit
ALTER TABLE not_explot_fet ADD tmp_reg_sac NUMBER(38, 0);
