 ...
 */
@Entity
@Table(name = BaseConfig.DB_PREFIX + "formats_sobre")
@Getter
@Setter
@NoArgsConstructor
public class PagadorCieFormatSobreResourceEntity
	extends BaseAuditableResourceEntity<PagadorCieFormatSobreResource>
	implements AdminEntitatResourceEntity<PagadorCieFormatSobreResource> {
	...
	@Builder
	public PagadorCieFormatSobreResourceEntity(
		PagadorCieFormatSobreResource resource,
