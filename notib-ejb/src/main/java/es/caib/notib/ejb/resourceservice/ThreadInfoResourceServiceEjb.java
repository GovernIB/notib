...
@Stateless
@RolesAllowed("**")
public class ThreadInfoResourceServiceEjb extends AbstractServiceEjb<ThreadInfoResourceService> implements ThreadInfoResourceService {

	@Delegate private ThreadInfoResourceService delegateService;

	protected void setDelegateService(ThreadInfoResourceService delegateService) {
