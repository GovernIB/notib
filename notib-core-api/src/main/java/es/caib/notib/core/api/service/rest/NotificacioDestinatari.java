...
public class NotificacioDestinatari {
	...
	private NotificaServeiTipus serveiTipus;
	private int retardPostal;
	private Date caducitat;
	private String referencia;
	private String notificaIdentificador;
	private NotificaEstat notificaEstat;
	private String notificaEstatNumSeguiment;
//	private Date notificaEstatDataActualitzacio;
	private NotificaCertificacioTipus notificaCertificacioTipus;
	private NotificaCertificacioArxiuTipus notificaCertificacioArxiuTipus;
	...
	public NotificacioDestinatari(
			...
			NotificaDomiciliTipus domiciliTipus,
			NotificaDomiciliConcretTipus domiciliConcretTipus,
			String domiciliViaTipus,
			String domiciliViaNom,
			NotificaDomiciliNumeracioTipus domiciliNumeracioTipus,
			...
			NotificaServeiTipus serveiTipus,
			int retardPostal,
			Date caducitat,
			String referencia,
			String notificaIdentificador,
			NotificaEstat notificaEstat,
			String notificaEstatNumSeguiment,
//			Date notificaEstatDataActualitzacio,
			NotificaCertificacioTipus notificaCertificacioTipus,
			NotificaCertificacioArxiuTipus notificaCertificacioArxiuTipus,
...
//		this.notificaEstatDataActualitzacio = notificaEstatDataActualitzacio;
	...
	public NotificaDomiciliTipus getDomiciliTipus() {
		return domiciliTipus;
	}



	public void setDomiciliTipus(NotificaDomiciliTipus domiciliTipus) {
		this.domiciliTipus = domiciliTipus;
	}



	public NotificaDomiciliConcretTipus getDomiciliConcretTipus() {
		return domiciliConcretTipus;
	}



	public void setDomiciliConcretTipus(NotificaDomiciliConcretTipus domiciliConcretTipus) {
		this.domiciliConcretTipus = domiciliConcretTipus;
	}
	...
	public NotificaDomiciliNumeracioTipus getDomiciliNumeracioTipus() {
		return domiciliNumeracioTipus;
	}



	public void setDomiciliNumeracioTipus(NotificaDomiciliNumeracioTipus domiciliNumeracioTipus) {
		this.domiciliNumeracioTipus = domiciliNumeracioTipus;
	}
	...
	public NotificaServeiTipus getServeiTipus() {
		return serveiTipus;
	}



	public void setServeiTipus(NotificaServeiTipus serveiTipus) {
		this.serveiTipus = serveiTipus;
	}
	...
	public NotificaEstat getNotificaEstat() {
		return notificaEstat;
	}



	public void setNotificaEstat(NotificaEstat notificaEstat) {
		this.notificaEstat = notificaEstat;
	}
...
//
//
//	public void setNotificaEstatDataActualitzacio(Date notificaEstatDataActualitzacio) {
//		this.notificaEstatDataActualitzacio = notificaEstatDataActualitzacio;
//	}



	public NotificaCertificacioTipus getNotificaCertificacioTipus() {
		return notificaCertificacioTipus;
	}



	public void setNotificaCertificacioTipus(NotificaCertificacioTipus notificaCertificacioTipus) {
		this.notificaCertificacioTipus = notificaCertificacioTipus;
	}



	public NotificaCertificacioArxiuTipus getNotificaCertificacioArxiuTipus() {
		return notificaCertificacioArxiuTipus;
	}



	public void setNotificaCertificacioArxiuTipus(NotificaCertificacioArxiuTipus notificaCertificacioArxiuTipus) {
		this.notificaCertificacioArxiuTipus = notificaCertificacioArxiuTipus;
	}
