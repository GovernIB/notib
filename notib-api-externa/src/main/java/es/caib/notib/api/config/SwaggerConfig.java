package es.caib.notib.api.config;
...
@Configuration
@EnableSwagger
@ComponentScan(basePackages = {"es.caib.notib.api.externa.controller"})
public class SwaggerConfig {
    ...
    public SwaggerSpringMvcPlugin customImplementation() {
        return new SwaggerSpringMvcPlugin(this.springSwaggerConfig)
                ...
                .includePatterns(".*/reports/*.*", ".*/stats/*/*.*", ".*/opendata");
    }
 
	private ApiInfo apiInfo() {
		ApiInfo apiInfo = new ApiInfo(
				"API Consulta NOTIB",
				"API EXTERNA de Consulta de NOTIB",
