...
public class OrganGestorHelper {
	...
	public List<String> findCodiOrgansGestorsWithPermisPerConsulta(Authentication auth,
																   EntitatEntity entitat,
																   PermisEnum permis) {
		List<CodiValorDto> organs = permisosService.getOrgansAmbPermisPerConsulta(entitat.getId(), auth.getName(), permis);
