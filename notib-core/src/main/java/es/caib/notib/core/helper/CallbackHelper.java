...
public class CallbackHelper {
	...
	public String notificaEstat(NotificacioDestinatariEntity destinatari) throws Exception {
			
		if (destinatari == null)
			throw new Exception("El destinatari no pot ser nul.");
		
		// Resol si hi ha una aplicació pel codi d'usuari que ha creat l'enviament
		UsuariEntity usuari = destinatari.getCreatedBy();
	...
	public String notificaCertificat(NotificacioDestinatariEntity destinatari) throws Exception{
		...
		if (destinatari.getNotificaCertificacioArxiuId() == null)
