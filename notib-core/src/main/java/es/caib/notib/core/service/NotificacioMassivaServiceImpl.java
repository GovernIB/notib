...
import es.caib.notib.core.api.dto.notificacio.NotificacioMassivaPrioritatDto;
...
import es.caib.notib.core.helper.EmailNotificacioMassivaHelper;
...
import es.caib.notib.core.helper.NotificacioListHelper;
import es.caib.notib.core.helper.NotificacioMassivaHelper;
...
//                filtreNetejat.getHasZeronotificaEnviamentIntent().getField(),
    ...
    private void crearNotificacio(EntitatEntity entitat, NotificacioDatabaseDto notificacio, NotificacioMassivaEntity notMassiva, Map<String, Long> documentsProcessatsMassiu) throws RegistreNotificaException {
        ...
        notificacioHelper.auditaNotificacio(notificacioEntity, AuditService.TipusOperacio.CREATE, "NotificacioMassivaServiceImpl.crearNotificacio");
