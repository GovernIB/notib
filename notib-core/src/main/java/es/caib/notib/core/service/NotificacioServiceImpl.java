	...
	public PaginaDto<NotificacioDatatableDto> findAmbFiltrePaginat(
		...
		try {
			...
			if (filtre == null || filtre.isEmpty()) {
				...
				OrganGestorEntity organGestor = filtre.getOrganGestor() != null ?
					organGestorRepository.findByCodi(filtre.getOrganGestor()) : null;
				ProcedimentEntity procediment = filtre.getProcedimentId() != null ?
					procedimentRepository.findById(filtre.getProcedimentId()) : null;
