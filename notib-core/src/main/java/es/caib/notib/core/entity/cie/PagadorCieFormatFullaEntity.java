 ...
 */
@Entity
@Table(name = "not_formats_fulla")
@EntityListeners(AuditingEntityListener.class)
public class PagadorCieFormatFullaEntity extends NotibAuditable<Long> {
	...
	@ForeignKey(name = "not_formats_fulla_fk")
	...
	public static class Builder {
		...
		public PagadorCieFormatFullaEntity build() {
			return built;
		}
	}
